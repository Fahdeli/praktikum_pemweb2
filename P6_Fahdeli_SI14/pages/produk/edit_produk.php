  ...
  ?>         
    ...
    <form method="POST" action="../../process/produk/proses_produk.php">
        ...
        <div class="form-group">
            ...
            <input id="harga_beli" value="<?= $result['harga_beli'] ?>"name="harga_beli" required type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="min_stok" value="<?= $result['min_stok'] ?>" name="min_stok" required type="text" class="form-control">
        </div>
        <div class="form-group">
